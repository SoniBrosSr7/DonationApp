      ...
      <>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='/donor-registration-from' element={<DonorRegistrationForm></DonorRegistrationForm>}></Route>
            <Route path='/donor-login' element={<DonorLoginForm></DonorLoginForm>}></Route>
